...
HD_PWD='D:/vivado_projects/CPU_Board/CPU_Board.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_Board.vdi -applog -m64 -messageDb vivado.pb -mode batch -source CPU_Board.tcl -notrace
