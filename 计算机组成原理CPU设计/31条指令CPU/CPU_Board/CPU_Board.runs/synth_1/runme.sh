...
HD_PWD='D:/vivado_projects/CPU_Board/CPU_Board.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_Board.vds -m64 -mode batch -messageDb vivado.pb -notrace -source CPU_Board.tcl
