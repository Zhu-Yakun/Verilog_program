...
HD_PWD='D:/vivado_projects/CPU_Board/CPU_Board.runs/IPcore_Board_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IPcore_Board.vds -m64 -mode batch -messageDb vivado.pb -notrace -source IPcore_Board.tcl
