...
#
# Generated by export_simulation on Sun May 19 00:58:15 +0800 2024
#
################################################################################
...
switch to the './IPcore_Board.sh' script.

./IPcore_Board.sh -reset_run
...
./IPcore_Board.sh -noclean_files

For more information on the script, please type './IPcore_Board.sh -help'.
