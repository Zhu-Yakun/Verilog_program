...
HD_PWD='D:/vivado_projects/regfile_test/regfile_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RegFile.vds -m64 -mode batch -messageDb vivado.pb -notrace -source RegFile.tcl
