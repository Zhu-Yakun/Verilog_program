...
set rc [catch {
  ...
  set_property ip_repo_paths d:/vivado_projects/three_state_gates/three_state_gates.cache/ip [current_project]
  set_property ip_output_repo d:/vivado_projects/three_state_gates/three_state_gates.cache/ip [current_project]
  add_files -quiet D:/vivado_projects/three_state_gates/three_state_gates.runs/synth_1/three_state_gates.dcp
