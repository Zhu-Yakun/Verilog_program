...
set rc [catch {
  ...
  set_property ip_repo_paths d:/vivado_projects/decoder/decoder.cache/ip [current_project]
  set_property ip_output_repo d:/vivado_projects/decoder/decoder.cache/ip [current_project]
  add_files -quiet D:/vivado_projects/decoder/decoder.runs/synth_1/decoder.dcp
