...
set rc [catch {
  ...
  set_property webtalk.parent_dir D:/vivado_projects/logic_gates_3/logic_gates_3.cache/wt [current_project]
  set_property parent.project_path D:/vivado_projects/logic_gates_3/logic_gates_3.xpr [current_project]
  set_property ip_repo_paths d:/vivado_projects/logic_gates_3/logic_gates_3.cache/ip [current_project]
  set_property ip_output_repo d:/vivado_projects/logic_gates_3/logic_gates_3.cache/ip [current_project]
  add_files -quiet D:/vivado_projects/logic_gates_3/logic_gates_3.runs/synth_1/logic_gates_3.dcp
  read_xdc D:/vivado_projects/logic_gates_3/logic_gates_3.srcs/constrs_1/new/top_xdc.xdc
