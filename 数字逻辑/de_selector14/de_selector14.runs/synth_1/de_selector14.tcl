...
read_verilog -library xil_defaultlib D:/vivado_projects/de_selector14/de_selector14.srcs/sources_1/new/de_selector14.v
foreach dcp [get_files -quiet -all *.dcp] {
  set_property used_in_implementation false $dcp
}
read_xdc D:/vivado_projects/de_selector14/de_selector14.srcs/constrs_1/new/top_xdc.xdc
set_property used_in_implementation false [get_files D:/vivado_projects/de_selector14/de_selector14.srcs/constrs_1/new/top_xdc.xdc]
